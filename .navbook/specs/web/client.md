...
- **Pull requests**, read and reviewed: listing with the all-branches toggle, revisions, comments and reviews bound to a revision, and the refusal to comment on a branch the server does not hold, shown with the branch it names.
