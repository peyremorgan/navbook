...
/**
 * A comment, or a review when any review field is set.
 *
...
export type Status = "CLOSED" | "MERGED" | "OPEN";
...
export type ResolversTypes = {
  ...
  AddCommentPayload: ResolverTypeWrapper<
    Omit<AddCommentPayload, "comment" | "entity"> & {
      comment: ResolversTypes["Comment"];
      entity: ResolversTypes["Entity"];
    }
  >;
  Boolean: ResolverTypeWrapper<Scalars["Boolean"]["output"]>;
  CloseIssueInput: CloseIssueInput;
  CloseIssuePayload: ResolverTypeWrapper<
    Omit<CloseIssuePayload, "issue"> & { issue: ResolversTypes["Issue"] }
  >;
  ...
  DoctorReport: ResolverTypeWrapper<
    Omit<DoctorReport, "diagnostics"> & { diagnostics: Array<ResolversTypes["Diagnostic"]> }
  >;
  ...
  LinkIssuePayload: ResolverTypeWrapper<
    Omit<LinkIssuePayload, "child" | "parent"> & {
      child: ResolversTypes["Issue"];
      parent: ResolversTypes["Issue"];
    }
  >;
  ...
  OpenIssuePayload: ResolverTypeWrapper<
    Omit<OpenIssuePayload, "issue" | "parent"> & {
      issue: ResolversTypes["Issue"];
      parent?: Maybe<ResolversTypes["Issue"]>;
    }
  >;
  Pr: ResolverTypeWrapper<PrParent>;
  Query: ResolverTypeWrapper<Record<PropertyKey, never>>;
  ReopenIssuePayload: ResolverTypeWrapper<
    Omit<ReopenIssuePayload, "issue"> & { issue: ResolversTypes["Issue"] }
  >;
  Revision: ResolverTypeWrapper<Revision>;
  Status: Status;
  String: ResolverTypeWrapper<Scalars["String"]["output"]>;
  UnlinkIssuePayload: ResolverTypeWrapper<
    Omit<UnlinkIssuePayload, "child"> & { child: ResolversTypes["Issue"] }
  >;
  UpdateIssueInput: UpdateIssueInput;
  UpdateIssuePayload: ResolverTypeWrapper<
    Omit<UpdateIssuePayload, "issue"> & { issue: ResolversTypes["Issue"] }
  >;
  Verdict: Verdict;
...
export type ResolversParentTypes = {
  AddCommentInput: AddCommentInput;
  AddCommentPayload: Omit<AddCommentPayload, "comment" | "entity"> & {
    comment: ResolversParentTypes["Comment"];
    entity: ResolversParentTypes["Entity"];
  };
  ...
  DoctorReport: Omit<DoctorReport, "diagnostics"> & {
    diagnostics: Array<ResolversParentTypes["Diagnostic"]>;
  };
  Entity: EntityParent;
  EntityFilter: EntityFilter;
  ID: Scalars["ID"]["output"];
  ...
  Issue: IssueParent;
  LinkIssueInput: LinkIssueInput;
  LinkIssuePayload: Omit<LinkIssuePayload, "child" | "parent"> & {
    child: ResolversParentTypes["Issue"];
    parent: ResolversParentTypes["Issue"];
  };
  LinkNode: LinkNodeParent;
  MergedInfo: MergedInfo;
  Mutation: Record<PropertyKey, never>;
  OpenIssueInput: OpenIssueInput;
  OpenIssuePayload: Omit<OpenIssuePayload, "issue" | "parent"> & {
    issue: ResolversParentTypes["Issue"];
    parent?: Maybe<ResolversParentTypes["Issue"]>;
  };
  Pr: PrParent;
...
export type CommitInfoResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["CommitInfo"] = ResolversParentTypes["CommitInfo"],
> = {
...
export type DoctorReportResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["DoctorReport"] = ResolversParentTypes["DoctorReport"],
> = {
...
> = {
  ...
  subtasks?: Resolver<
    Array<ResolversTypes["LinkNode"]>,
    ParentType,
    ContextType,
    RequireFields<IssueSubtasksArgs, "depth">
  >;
  title?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LinkIssuePayloadResolvers<
  ContextType = GraphQLCtx,
  ParentType extends
    ResolversParentTypes["LinkIssuePayload"] = ResolversParentTypes["LinkIssuePayload"],
> = {
...
export type LinkNodeResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["LinkNode"] = ResolversParentTypes["LinkNode"],
> = {
...
export type MergedInfoResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["MergedInfo"] = ResolversParentTypes["MergedInfo"],
> = {
...
> = {
  ...
  >;
  closeIssue?: Resolver<
    ResolversTypes["CloseIssuePayload"],
    ParentType,
    ContextType,
    RequireFields<MutationCloseIssueArgs, "input">
  >;
  linkIssue?: Resolver<
    ResolversTypes["LinkIssuePayload"],
    ParentType,
    ContextType,
    RequireFields<MutationLinkIssueArgs, "input">
  >;
  openIssue?: Resolver<
    ResolversTypes["OpenIssuePayload"],
    ParentType,
    ContextType,
    RequireFields<MutationOpenIssueArgs, "input">
  >;
  reopenIssue?: Resolver<
    ResolversTypes["ReopenIssuePayload"],
    ParentType,
    ContextType,
    RequireFields<MutationReopenIssueArgs, "ref">
  >;
  unlinkIssue?: Resolver<
    ResolversTypes["UnlinkIssuePayload"],
    ParentType,
    ContextType,
    RequireFields<MutationUnlinkIssueArgs, "ref">
  >;
  updateIssue?: Resolver<
    ResolversTypes["UpdateIssuePayload"],
    ParentType,
    ContextType,
...
export type OpenIssuePayloadResolvers<
  ContextType = GraphQLCtx,
  ParentType extends
    ResolversParentTypes["OpenIssuePayload"] = ResolversParentTypes["OpenIssuePayload"],
> = {
  commit?: Resolver<ResolversTypes["CommitInfo"], ParentType, ContextType>;
  issue?: Resolver<ResolversTypes["Issue"], ParentType, ContextType>;
...
export type PrResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["Pr"] = ResolversParentTypes["Pr"],
> = {
  archived?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
  assignees?: Resolver<Array<ResolversTypes["String"]>, ParentType, ContextType>;
  author?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
  ...
  issue?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryIssueArgs, "ref">
  >;
  issues?: Resolver<
  ...
  prs?: Resolver<
    Array<ResolversTypes["Pr"]>,
    ParentType,
    ContextType,
    RequireFields<QueryPrsArgs, "allRefs">
  >;
...
export type RevisionResolvers<
  ContextType = GraphQLCtx,
  ParentType extends ResolversParentTypes["Revision"] = ResolversParentTypes["Revision"],
> = {
...
export type UnlinkIssuePayloadResolvers<
  ContextType = GraphQLCtx,
  ParentType extends
    ResolversParentTypes["UnlinkIssuePayload"] = ResolversParentTypes["UnlinkIssuePayload"],
> = {
  child?: Resolver<ResolversTypes["Issue"], ParentType, ContextType>;
  commit?: Resolver<ResolversTypes["CommitInfo"], ParentType, ContextType>;
  previousParentId?: Resolver<Maybe<ResolversTypes["ID"]>, ParentType, ContextType>;
