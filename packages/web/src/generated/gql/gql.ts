...
type Documents = {
    ...
    "\n  fragment ChangedFileFields on ChangedFile {\n    path\n    oldPath\n    status\n    additions\n    deletions\n    binary\n    lines\n    patch\n    truncated\n  }\n": typeof types.ChangedFileFieldsFragmentDoc,
    ...
    "\n  query PrCommits($ref: ID!, $limit: Int!) {\n    pr(ref: $ref) {\n      id\n      commits(limit: $limit) {\n        total\n        commits {\n          sha\n          subject\n          author\n          date\n        }\n      }\n    }\n  }\n": typeof types.PrCommitsDocument,
    "\n  query PrChanges($ref: ID!) {\n    pr(ref: $ref) {\n      id\n      changes {\n        base\n        head\n        additions\n        deletions\n        files {\n          ...ChangedFileFields\n        }\n      }\n    }\n  }\n": typeof types.PrChangesDocument,
    "\n  query PrFileChanges($ref: ID!, $paths: [String!]!) {\n    pr(ref: $ref) {\n      id\n      changes(paths: $paths) {\n        files {\n          ...ChangedFileFields\n        }\n      }\n    }\n  }\n": typeof types.PrFileChangesDocument,
};
const documents: Documents = {
    ...
    "\n  fragment ChangedFileFields on ChangedFile {\n    path\n    oldPath\n    status\n    additions\n    deletions\n    binary\n    lines\n    patch\n    truncated\n  }\n": types.ChangedFileFieldsFragmentDoc,
    ...
    "\n  query Inbox($me: String!, $text: [String!], $finished: Boolean!) {\n    assignedIssues: issues(filter: { assignees: [$me], status: [OPEN], text: $text }) {\n      ...IssueListItem\n    }\n    assignedPrs: prs(filter: { assignees: [$me], status: [OPEN], text: $text }, allRefs: true) {\n      ...PrListItem\n    }\n    authoredPrs: prs(filter: { authors: [$me], status: [OPEN], text: $text }, allRefs: true) {\n      ...PrListItem\n    }\n    awaitingPrs: prs(filter: { awaiting: [$me], status: [OPEN], text: $text }, allRefs: true) {\n      ...PrListItem\n    }\n    finishedAssignedIssues: issues(filter: { assignees: [$me], status: [CLOSED], text: $text })\n      @include(if: $finished) {\n      ...IssueListItem\n    }\n    finishedAssignedPrs: prs(\n      filter: { assignees: [$me], status: [CLOSED, MERGED], text: $text }\n      allRefs: false\n    ) @include(if: $finished) {\n      ...PrListItem\n    }\n    finishedAuthoredPrs: prs(\n      filter: { authors: [$me], status: [CLOSED, MERGED], text: $text }\n      allRefs: false\n    ) @include(if: $finished) {\n      ...PrListItem\n    }\n  }\n": types.InboxDocument,
    "\n  query PrCommits($ref: ID!, $limit: Int!) {\n    pr(ref: $ref) {\n      id\n      commits(limit: $limit) {\n        total\n        commits {\n          sha\n          subject\n          author\n          date\n        }\n      }\n    }\n  }\n": types.PrCommitsDocument,
    "\n  query PrChanges($ref: ID!) {\n    pr(ref: $ref) {\n      id\n      changes {\n        base\n        head\n        additions\n        deletions\n        files {\n          ...ChangedFileFields\n        }\n      }\n    }\n  }\n": types.PrChangesDocument,
    "\n  query PrFileChanges($ref: ID!, $paths: [String!]!) {\n    pr(ref: $ref) {\n      id\n      changes(paths: $paths) {\n        files {\n          ...ChangedFileFields\n        }\n      }\n    }\n  }\n": types.PrFileChangesDocument,
};
